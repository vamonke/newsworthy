...
// Listed in desk order, mixed so the creatures (gorilla, octopus, monster) aren't side by side.
export const EVENTS=[
 ...
 {id:'monster',code:'MON',name:'Monster',label:'Monster',prompt:'A colossal green flying monster circles low above the downtown intersection. Its enormous green bat-like wings fill the sky and cast a dark shadow over the traffic. The creature stays fully visible above the street.'},
 {id:'plane',code:'AIR',name:'Plane',label:'Plane',prompt:'A passenger plane crashes onto the broad city street. Broken wings and the aircraft body fill the road as flames and smoke rise around them.'},
