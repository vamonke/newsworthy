...
export const EVENTS=[
 ...
 {id:'robot',code:'BOT',name:'Giant robot',label:'Giant robot',prompt:'A colossal humanoid robot strides slowly down the main avenue beside the downtown intersection. Its enormous red metal head, chest, two arms, and two legs are clearly visible from the helicopter. The robot is taller than the nearby buildings, and cars look tiny around its feet. Its full body remains centered and visible in the street.'},
 {id:'tornado',code:'TRN',name:'Tornado',label:'Tornado',prompt:'A huge rotating tornado fills the street between the buildings. Debris spins around the funnel.'},
 ...
 {id:'portal',code:'PRT',name:'Mysterious portal',label:'Mysterious portal',prompt:'A gigantic circular portal floats above the downtown intersection. Its bright swirling center and glowing colored rim fill the sky while strange light shines onto the cars below. The portal stays fully visible.'},
 {id:'blimp',code:'BLP',name:'Runaway blimp',label:'Runaway blimp',prompt:'A huge damaged news blimp drifts dangerously low between the downtown buildings. The blimp fills the sky above the intersection and trails a long plume of dark smoke.'},
